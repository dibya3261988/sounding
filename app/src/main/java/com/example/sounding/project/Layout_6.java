...
public class Layout_6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tombol5 = (Button)findViewById(R.id.ke_layout_1);

        tombol5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //kode untuk pindah ke actifity lain
                pindah5 = new Intent(Layout_6.this, MainActivity.class);
    ...
    /* private void hitungLuas(){
        ...
        if (lebar > 40) {
            ...
            double SG = Double.parseDouble("1.270".toString());
            double x;
            if (lebar == 41) {
                x = 1;
            } else if (lebar == 42) {
    ...
    */
    ...
    private void hitungLuas(){
        ...
        //=(3,14*$AB$3*$AB$3*E14499/1000)+(0,33*3,14*$AB$3*$AB$3*40/1000)
        double luas = (phi*(jari*jari)*lebar/1000)+(p3*phi*(jari*jari)*kons/1000);
        //NumberFormat format = new DecimalFormat("0.#");
        DecimalFormat decimalFormat = new DecimalFormat("#,##0.00");
        String numberAsString = decimalFormat.format(luas);
        //edtLuas.setText(NumberFormat.getCurrencyInstance(Locale.ENGLISH).format(luas));
        ...
        //edtBeratKg.setText(DecimalFormat.getNumberInstance(Locale.US).format(beratkg)+"");
        ...
        edtKesimpulan.setText(pil1 + dapil + strDate + dapil + tank + dapil + DecimalFormat.getNumberInstance(Locale.US).format(beratkg) + dapil + pil2 + dapil + pil3.toUpperCase());
