...
public class Layout_7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tombol6 = (Button)findViewById(R.id.ke_layout_1);

        tombol6.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //kode untuk pindah ke actifity lain
                pindah6 = new Intent(Layout_7.this, MainActivity.class);
