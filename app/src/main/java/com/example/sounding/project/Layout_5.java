...
public class Layout_5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tombol4 = (Button)findViewById(R.id.ke_layout_1);

        tombol4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //kode untuk pindah ke actifity lain
                pindah4 = new Intent(Layout_5.this, MainActivity.class);
    ...
    private void hitungLuas(){
        ...
        double luas = ((532-5)-lebar)/100; //rumus pelampung
        ...
        double beratkg = phi*(((Math.pow(((882.4/100)/2),2)*luas)*SG)*1000);
