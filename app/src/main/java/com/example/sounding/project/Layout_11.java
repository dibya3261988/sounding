...
public class Layout_11 extends AppCompatActivity {
    Button tombol10;
    Intent pindah10;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.layout_11);
        ...
        tombol10 = (Button)findViewById(R.id.ke_layout_1);

        tombol10.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //kode untuk pindah ke actifity lain
                pindah10 = new Intent(Layout_11.this, MainActivity.class);
    ...
    private void hitungLuas(){
        ...
        double kons = Double.parseDouble("30".toString());
