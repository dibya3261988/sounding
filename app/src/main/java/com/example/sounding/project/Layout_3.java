...
//Layout3 adalah untuk tangki UF2
...
public class Layout_3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tombol2 = (Button)findViewById(R.id.ke_layout_1);
        ...
        tombol2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                pindah2 = new Intent(Layout_3.this, MainActivity.class);
