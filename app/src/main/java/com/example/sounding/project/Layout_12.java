...
public class Layout_12 extends AppCompatActivity {
    Button tombol11;
    Intent pindah11;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tombol11 = (Button)findViewById(R.id.ke_layout_1);

        tombol11.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //kode untuk pindah ke actifity lain
                pindah11 = new Intent(Layout_12.this, MainActivity.class);
    ...
    private void initUI(){
        ...
        getSG = (EditText) findViewById(R.id.editTextLebarSG);
    }
    ...
    private void cekKondisi() {
        ...
        } else if(getSG.getText().toString().length()==0){
            getSG.setError("SG diperlukan!");
        }
        else {
            hitungLuas();
            addEmployee();
    ...
    private void hitungLuas(){
        ...
        Float speg = Float.parseFloat(getSG.getText().toString());
